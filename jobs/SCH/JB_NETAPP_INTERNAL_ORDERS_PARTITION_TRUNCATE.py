# SCH2001.SH --> JB_NETAPP_INTERNAL_ORDERS_PARTITION_TRUNCATE.py
...
# Description  :
#
#             1. This script will Truncates the Partition for 'NETAPP_INTERNAL_ORDERS' table.
#
# Initial Creation:
#
...
# 2018-11-05                    Bibin Vasudevan : Using job_debugger_print() for print any string in Job
#
# **************************************************************************************************************
...
app_name = "JB_NETAPP_INTERNAL_ORDERS_PARTITION_TRUNCATE"

# Truncate Table Details
truncate_table = 'NETAPP_INTERNAL_ORDERS'
