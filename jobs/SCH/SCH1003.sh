...
# Description  :
#       1. This bash scipt is mainly for 'JB_PARTNER_NETAPP_SALES_TRUNCATE', 'JB_PARTNER_NETAPP_SALES' jobs.
...
path="$1"
truncate_job="JB_PARTNER_NETAPP_SALES_TRUNCATE"
insert_job="JB_PARTNER_NETAPP_SALES"
