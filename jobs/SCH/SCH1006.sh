...
# Description  :
#       1. This bash scipt is mainly for 'JB_PARTNER_PURCHASING_CHANNEL_TRUNCATE' and 'JB_PARTNER_PURCHASING_CHANNEL'.
...
path="$1"
truncate_job="JB_PARTNER_PURCHASING_CHANNEL_TRUNCATE"
insert_job="JB_PARTNER_PURCHASING_CHANNEL"
