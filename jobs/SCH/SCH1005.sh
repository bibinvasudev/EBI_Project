...
#       1. This bash scipt is mainly for 'JB_PARTNER_PROGRAM_BENEFITS_TRUNCATE' and 'JB_PARTNER_PROGRAM_BENEFITS' jobs.
...
path="$1"
truncate_job="JB_PARTNER_PROGRAM_BENEFITS_TRUNCATE"
insert_job="JB_PARTNER_PROGRAM_BENEFITS"
...
path=`pwd`
echo -e "\n	Run time argumets are not passed, Running with ${conf_file} file "
spark_run_func
fi
}
