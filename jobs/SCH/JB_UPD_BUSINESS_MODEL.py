# SCH1002.sh  --> JB_UPD_BUSINESS_MODEL.py
...
app_name = 'JB_UPD_BUSINESS_MODEL'
...
def main():
        try:
            ...
            update_query = "Update "+db_schema+"."+target_table+" \
                            SET MODEL_START_DT_FISCAL_QTR = (SELECT FISCAL_YEAR_QTR_TEXT FROM "+db_schema+".CALENDAR\
                            WHERE TRUNC(BK_CALENDAR_DATE) = TRUNC(MODEL_START_DATE))"
