# SCH1101.sh  --> JB_SALES_HIERARCHY_FLAG_N.py
...
app_name = "JB_SALES_HIERARCHY_FLAG_N"
...
def query_data(db_schema):
        ...
        AND BK_SALES_REP_NUMBER NOT IN (SELECT DISTINCT BK_SALES_REP_NUMBER FROM DIMS.SALES_PARTICIPANT WHERE PARTICIPANT_LEVEL_CODE = 'SR')
        ---AND BK_SALES_REP_NUMBER = 916327
