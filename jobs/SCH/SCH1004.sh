...
#       1. This bash scipt is mainly for 'JB_PARTNER_PROGRAM_TRUNCATE', 'JB_PARTNER_PROGRAM' and 'JB_UPD_PARTNER_PROGRAM' jobs.
...
path="$1"
truncate_job="JB_PARTNER_PROGRAM_TRUNCATE"
insert_job="JB_PARTNER_PROGRAM"
update_job="JB_UPD_PARTNER_PROGRAM"
...
spark_run_func(){
for job_name in $truncate_job $insert_job $update_job
do
